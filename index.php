...
<body>
    ...
    <div id="register-modal" class="modal">
        <div class="modal-content">
            ...
            <h2>ลงทะเบียน</h2>
            <form action="system/register.php" method="post" id="registration-form" class="modal-form">
                <div class="form-group">
                    <label for="reg-firstname">ชื่อ</label>
                    <input type="text" id="reg-firstname" placeholder="กรุณากรอกชื่อ" name="firstname" required>
                </div>
                <div class="form-group">
                    <label for="reg-lastname">นามสกุล</label>
                    <input type="text" id="reg-lastname" placeholder="กรุณากรอกนามสกุล" name="lastname" required>
                </div>
                <div class="form-group">
                    <label for="reg-id">เลขบัตรประชาชน</label>
                    <input type="text" id="reg-id" placeholder="กรุณากรอกเลขบัตรประชาชน 13 หลัก" pattern="[0-9]{13}" name="id_number" required>
                </div>
                <div class="form-group">
                    <label for="reg-email">อีเมล</label>
                    <input type="email" id="reg-email" placeholder="กรุณากรอกอีเมล" name="email" required>
                </div>
                <div class="form-group">
                    <label for="reg-password">รหัสผ่าน</label>
                    <input type="password" id="reg-password" placeholder="กรุณากรอกรหัสผ่าน" name="password" required>
                </div>
